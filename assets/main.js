...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-3', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.style-1', { style: 'zoom-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-1', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
